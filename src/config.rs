...
pub use self::{
    ...
    model::{
        validated_sidebar_bounds, AgentPanelModeConfig, AgentPanelScopeConfig,
        AgentPanelSortConfig, Config, ConfigReloadReport, ConfigReloadStatus, HostCursorModeConfig,
        NewTerminalCwdConfig, ShellModeConfig, SidebarCollapsedModeConfig, ToastClipboardPosition,
