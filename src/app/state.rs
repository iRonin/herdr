use crate::config::{
    Keybinds, NewTerminalCwdConfig, ScrollbarMode, SoundConfig, TabBarPositionConfig, ToastConfig,
    ToastDelivery,
};
...
pub(crate) enum DragTarget {
    ...
    TabReorder {
        ...
        /// other than the tab's own workspace; while set, `drop_target` stays
