...
# Pane scrollbars: "always" reserves a column, "auto" briefly overlays the
# rightmost text column after scrolling, and "never" reclaims the column and
# keeps it out of terminal-native selections.
# Boolean true/false remains accepted as "always"/"never".
