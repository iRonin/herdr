...
/// Cycle the agent-panel toggle on click: priority -> grouped -> space -> priority.
...
pub(crate) fn agent_panel_cycle_next(
    ...
    match scope {
        AgentPanelScope::Current => (AgentPanelSort::Priority, AgentPanelScope::All),
        AgentPanelScope::All => match sort {
            AgentPanelSort::Priority => (AgentPanelSort::Spaces, AgentPanelScope::All),
            AgentPanelSort::Spaces => (AgentPanelSort::Priority, AgentPanelScope::Current),
        },
    }
}
